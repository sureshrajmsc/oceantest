    ...
    <ScrollView>
      <View style={{ width: windowWidth, alignItems: 'center' }}>
        ...
        <View style={[styles.shadowProp, styles.container, { marginVertical: 5, padding: 10 }]}>
          ...
          <View><Text>This customer is available at:</Text></View>

          <View style={styles.flexpad}>
            <View><MIcon name='clock-time-three-outline' size={20} color='#000' style={{ paddingRight: 5 }} /></View>
            <View style={{ flex: 1 }}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                <Text style={styles.timetxt}>Sunday, December 22 nd, 2019 </Text>
                <Text style={styles.timetxt}>9:00 am - 2:00 pm</Text>
              </View>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                <Text style={styles.timetxt}>Sunday, December 29 nd, 2019 </Text>
                <Text style={styles.timetxt}>9:00 am - 2:00 pm</Text>
              </View>
            </View>
          </View>
          ...
          <View style={[styles.flexpad,{ alignItems: 'center', justifyContent: 'space-between' }]}>
            <TouchableOpacity onPress={() => dispatch(currentNav(0))} style={styles.buttontrans}>
              <Text style={styles.buttontranstxt}>Reschedule</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => { dispatch(currentNav(2)), navigation.navigate('ServicesScreen', { name: 'Jane' }) }} style={styles.button}>
              <Text style={styles.buttontxt}>Accept Request</Text>
            </TouchableOpacity>
